        ...
        <div class="cuadro">
            ...
            <div class="contenido">
                ...
                <div class="formulario">
                    <form name="fCancel" action="process.php" method="POST">
                        ...
                        <div class="datos-salon">
                            ...
                            <option id="redondo" value="">Motivo De Cancelacion</option>
                                ...
                                <option value="Sala Ya Solicitada"> Sala Ya Solicitada</option>
                       ...
                       <!-- <div class="titulo">
                        ...
                        <div class="boton-enviar">
                            <button type="submit" class="btn btn-inverse btn-lg btn-block" name="sendCancel" value="Enviar Solicitud">Confirmar Cancelacion</button>
                        </div>
                    </form>
                </div>
